...
- **app/admin/page.tsx** — Admin dashboard (e.g. users/gladiators).
...
| **Sprint plans (what to build)** | [docs/plans/00-MASTER-PLAN.md](docs/plans/00-MASTER-PLAN.md), [docs/plans/01-sprint-0-setup.md](docs/plans/01-sprint-0-setup.md) … [08-sprint-7-deployment.md](docs/plans/08-sprint-7-deployment.md) |
| **What’s been built (Sprint 1 & 2)** | [docs/SPRINT-1-SUMMARY.md](docs/SPRINT-1-SUMMARY.md), [docs/SPRINT-2-SUMMARY.md](docs/SPRINT-2-SUMMARY.md) |
...
- **README.md** — Entry point: goal, vision, success criteria, status & sprint roadmap (0–7), tech stack, game data & equipment summary, out of scope, project structure, quick start, documentation table, post-demo roadmap.
...
- **development-setup.md** — Prerequisites (Node, pnpm, Git, Supabase, MetaMask), clone, install, env configuration, database setup (Prisma push), running frontend and game server, verification URLs, troubleshooting (database connection/Supabase P1001, port conflicts).
